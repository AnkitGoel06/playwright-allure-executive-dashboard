...
test.describe('Quote', () => {
  ...
  test('Edit Quote', { tag: ['@Quote', '@Skip'] }, async ({ Given, When, Then }) => { 
    await Given('user has created quote'); 
    await When('user cancels quote'); 
    await Then('quote should be cancelled'); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":24,"pickleLine":23,"tags":["@Quote","@Skip"],"steps":[{"pwStepLine":25,"gherkinStepLine":24,"keywordType":"Context","textWithKeyword":"Given user has created quote","stepMatchArguments":[]},{"pwStepLine":26,"gherkinStepLine":25,"keywordType":"Action","textWithKeyword":"When user cancels quote","stepMatchArguments":[]},{"pwStepLine":27,"gherkinStepLine":26,"keywordType":"Outcome","textWithKeyword":"Then quote should be cancelled","stepMatchArguments":[]}]},
]; // bdd-data-end