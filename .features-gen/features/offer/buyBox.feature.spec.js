...
test.describe('Offer', () => {
  ...
  test('Multi Seller Selection', { tag: ['@Offer', '@Regression'] }, async ({ Given, When, Then, page }) => { 
    await Given('user opens PDP', null, { page }); 
    await When('user changes seller'); 
    await Then('seller inventory should be updated'); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":18,"pickleLine":17,"tags":["@Offer","@Regression"],"steps":[{"pwStepLine":19,"gherkinStepLine":18,"keywordType":"Context","textWithKeyword":"Given user opens PDP","stepMatchArguments":[]},{"pwStepLine":20,"gherkinStepLine":19,"keywordType":"Action","textWithKeyword":"When user changes seller","stepMatchArguments":[]},{"pwStepLine":21,"gherkinStepLine":20,"keywordType":"Outcome","textWithKeyword":"Then seller inventory should be updated","stepMatchArguments":[]}]},
  {"pwTestLine":24,"pickleLine":23,"tags":["@Offer","@Regression"],"steps":[{"pwStepLine":25,"gherkinStepLine":24,"keywordType":"Context","textWithKeyword":"Given user opens PDP","stepMatchArguments":[]},{"pwStepLine":26,"gherkinStepLine":25,"keywordType":"Action","textWithKeyword":"When user selects unavailable seller","stepMatchArguments":[]},{"pwStepLine":27,"gherkinStepLine":26,"keywordType":"Outcome","textWithKeyword":"Then seller should not be selectable","stepMatchArguments":[]}]},
]; // bdd-data-end