...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":18,"pickleLine":17,"tags":["@Login","@Skip"],"steps":[{"pwStepLine":19,"gherkinStepLine":18,"keywordType":"Context","textWithKeyword":"Given user opens login page","stepMatchArguments":[]},{"pwStepLine":20,"gherkinStepLine":19,"keywordType":"Action","textWithKeyword":"When user clicks forgot password","stepMatchArguments":[]},{"pwStepLine":21,"gherkinStepLine":20,"keywordType":"Outcome","textWithKeyword":"Then reset email should be sent","stepMatchArguments":[]}]},
]; // bdd-data-end